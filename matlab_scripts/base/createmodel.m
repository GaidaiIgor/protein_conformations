function [r, kParam, psi] = createmodel(PDBStruct)
%CREATEMODEL Calculate bond lengths, planar and torsion angles.
%   [r, kParam, psi] = createmodel(PDBStruct) calculates bond lengths,
...
%   planar angles - in the matrix kParam, and the torsion angles - in the
%   matrix psi. Each column of the matrices r, kParam, and psi corresponds
...
for i = 1:nModels
    ...
    kParam(:,i) = acos(dot(deltax(1:end-1,:), deltax(2:end,:), 2) ./ ...
